...
- `src/lokf-vocab.json` is generated by `npm run build-vocab` from the pinned LOKF schema. Refresh it, and commit the result, only when bumping that schema; it is kept identical to LOKF Registrar's.
