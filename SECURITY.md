...
Use GitHub's [private vulnerability reporting](https://github.com/noelmcloughlin/obsidian-lokf-curator/security/advisories/new), not a public issue or a pull request. Say which file is affected - plugin source, or a workflow under `.github/workflows/` - how it is exploitable, and the smallest reproduction you have. One person maintains this repository: expect a first reply in days, not hours, and no bounty.
...
LOKF Curator runs inside Obsidian, on the vault you open it in, and nowhere else.
