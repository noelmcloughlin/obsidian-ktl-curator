...
What Obsidian 1.13.7's file reconciler does with a link on each host is recorded in the skills' own playbook, [Open the knowledge bundle in Obsidian](https://github.com/noelmcloughlin/knowledge-trust-ladder/blob/main/.lokf/knowledge/playbooks/open-bundle-in-obsidian.md).
