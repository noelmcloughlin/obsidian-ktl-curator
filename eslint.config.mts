		...
		rules: {
			...
			'obsidianmd/ui/sentence-case': [
				'warn',
				{
					...
					// would otherwise "correct" the prefix to uppercase. The second
					// pattern exempts a bare slug shown as example input (the
					// curator-id placeholder "ada-lovelace"): the value really is
					// lowercase, so capitalizing it would misdescribe what to type.
					ignoreRegex: ['\\blokf:[A-Z]', '^[a-z0-9]+(?:-[a-z0-9]+)+$'],
					ignoreWords: [
						'IRI',
						// The pronoun, in the "Wrong - I corrected it" verb.
						'I',
						'RDF',
						'RelationType',
						'Concept',
