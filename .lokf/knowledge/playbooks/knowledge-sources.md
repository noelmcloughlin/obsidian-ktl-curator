...
| `src/curator-view.ts` | the "Curate" side panel: report + review card | `Service` | reading the `LokfCuratorView` class |
| `src/settings.ts` | the declarative settings tab | `Service` | reading `LokfCuratorSettingTab.getSettingDefinitions()` |
