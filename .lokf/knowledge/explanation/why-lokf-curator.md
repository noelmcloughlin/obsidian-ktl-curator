...
description: Where this plugin sits on the four-tier trust model, and why it is a companion to lokf-enforcer rather than a superset or a dependency of it.
genre: explanation
resource: README.md
about:
...
`lokf-enforcer` (a separate plugin) checks the first tier as you write. This
